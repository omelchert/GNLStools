...
from GNLStools import GNLS, qnoise_spectral_synthesis, qnoise_direct_sampling, cnoise
...
def main(del_G, t0_FWHM=50., s0=0):
    ...
    #du0_t = qnoise_spectral_synthesis(t,w0,s0)
    du0_t = cnoise(t,w0,s0)
    #exit()
    #du0_t = qnoise_direct_sampling(t,w0,s0)
