...
class Figure():
    ...
    def set_layout(self):
        ...
        plt.subplots_adjust(left = 0.08, bottom = 0.1, right = 0.89, top = 0.95, wspace = .05, hspace = 0.9)

        gs00 = GridSpec(nrows = 1, ncols = 2)

        gsA = GridSpecFromSubplotSpec(5, 1, subplot_spec=gs00[0,0], wspace=0.07, hspace=0.1)
        ...
        self.subfig_1 = [axA1, axA2, axA3, axA4, axA5]

        gsA = GridSpecFromSubplotSpec(5, 1, subplot_spec=gs00[0,1], wspace=0.07, hspace=0.1)
        axA1 = fig.add_subplot(gsA[0, 0])
        axA2 = fig.add_subplot(gsA[1, 0])
        axA3 = fig.add_subplot(gsA[2, 0])
        axA4 = fig.add_subplot(gsA[3, 0])
        axA5 = fig.add_subplot(gsA[4, 0])
        self.subfig_2 = [axA1, axA2, axA3, axA4, axA5]
...
def main():
    ...
    myFig = Figure(aspect_ratio=0.85, fig_basename="fig02", fig_format='png')
    myFig.set_layout()
